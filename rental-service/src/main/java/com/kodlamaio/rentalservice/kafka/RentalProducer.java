...
@Service
@AllArgsConstructor
public class RentalProducer { //olusan eventi yollacaksın
	...
	}//kiralama tablosuna yeni bir event ekleyecekken
	...
	public void sendMessage(RentalUpdatedEvent rentalUpdatedEvent) {
		...
		kafkaTemplate.send(message);
	}//kiralama tablosuna  bir eventi güncelleyecekken
	...
	public void sendMessage(RentalDeletedEvent rentalDeleteEvent) {
		...
		kafkaTemplate.send(message);
	}//kiralama tablosundan bir eventi silecekken

	
	public void sendMessage(PaymentReceivedEvent event) {//digerlerinde genelda sadece carId varken burada  model brand,kişi,günlük fiyt,total fiyat.kiraladıgı gün
