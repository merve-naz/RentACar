...
public class CarFilterManager implements CarFilterService {
	...
	@Override
	public DataResult<List<GetAllFiltersResponse>> getByBrandName(String brandName) {//marka adına göre 
	...
	@Override
	public DataResult<List<GetAllFiltersResponse>> getByModelName(String modelName) {//model adına göre
	...
	@Override
	public DataResult<GetFilterResponse> getByPlate(String plate) {//plakaya göre
	...
	@Override
	public DataResult<List<GetAllFiltersResponse>> searchByPlate(String plate) {//arama yaparken  yazdıgın  kadar  eşleşen  plakaları bulmak için 
	...
	@Override
	public DataResult<List<GetAllFiltersResponse>> searchByBrandName(String brandName) {//arama yaparken  yazdıgın  kadar  eşleşen  marka adlarını bulmak için 
	...
	@Override
	public DataResult<List<GetAllFiltersResponse>> searchByModelName(String modelName) {//arama yaparken  yazdıgın  kadar  eşleşen model adlarını bulmak için 
	...
	@Override
	public Result add(CarFilter carFilter) {//filterrepository   CarFilter(inventory olan tabloların birleşimi şeklinde tasarlandı) ekleme
		carFilterRepository.save(carFilter);
		return new SuccessResult();
	}

	@Override
	public Result delete(String id) {//filter repositoy'den CarFilter silme
		carFilterRepository.deleteByCarId(id);
		return new SuccessResult();
	}

	@Override
	public Result deleteAllByBrandId(String brandId) {//marka silme
		carFilterRepository.deleteAllByBrandId(brandId);
		return new SuccessResult();
	}

	@Override
	public Result deleteAllByModelId(String modelId) {//model silme
		carFilterRepository.deleteAllByModelId(modelId);
		return new SuccessResult();
	}

	private void checkIfExistByPlate(String plate) {//plaka silme(carId silme)
