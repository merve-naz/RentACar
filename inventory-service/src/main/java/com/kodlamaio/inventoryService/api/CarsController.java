...
public class CarsController {
	...
	@GetMapping("/checkCarAvailable/{id}")  //bunu apiye yazmamın en onemli sebebi rental'ın bu api'yi kullanarak checkCarAvailable fonksiyonuna erişebilmesi.
	...
	public GetCarResponse getCarResponse(@PathVariable String id) {
		return carService.getById(id).getData();//araç bilgilerini alıcaz
	}
}
